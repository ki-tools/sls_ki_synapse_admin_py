...
def parse_args():  # pragma: no cover
    ...
    parser.add_argument("--ssl-context", type=str, dest="ssl_context", default=None)

    return parser.parse_args()


def serve(cwd, app, port=5000, host="localhost", threaded=True, processes=1, ssl_context=None):
